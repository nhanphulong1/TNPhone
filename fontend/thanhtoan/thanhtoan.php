...
if (!isset($_COOKIE['kh_tendangnhap']) || empty($_COOKIE['kh_tendangnhap'])) {
    ...
    --- 
    */
    $kh_tendangnhap = $_COOKIE['kh_tendangnhap'];
...
//         $mail->addAddress($khachhangRow['kh_sdt']);               // Add a recipient
...
//                 <tr>
//                     <td colspan="2">
//                         <img src="/shared/logo.png" style="width: 100px; height: 100px; border: 1px solid red;" />
//                     </td>
//                 </tr>
//                 <tr>
